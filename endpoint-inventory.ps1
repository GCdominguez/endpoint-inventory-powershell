# Endpoint Inventory / Compliance Report v3
# Purpose:
# - Collect practical endpoint state
# - Save a new report only when meaningful content changes
# - Ignore volatile fields like GeneratedAt
# - Keep only the newest 5 report iterations
